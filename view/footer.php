            ...
            <div class="col-lg-4">
              <div class="footer-widgets_info">
                <div class="footer-widgets_logo">
                  <a href="#">
                    <img src="./src/image/menu/logo/logo.png" alt="JB's Header Logo" />
                  </a>
                </div>
                <div class="short-desc">
                  <p>
                    There are many variations of passages of Lorem Ipsum
                    available, but the majorited have suffered alteration.
                  </p>
                </div>
                <div class="widgets-essential_stuff">
                  <ul>
                    <li class="jb-address">
                      <span>Address:</span> 169-C, Technohub, Dubai Silicon
                      Oasis.
                    </li>
                    <li class="jb-email">
                      <span>Mail us:</span>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-6 col-md-6">
              <div class="copyright">
                <span>Copyright &copy; 2022 <a href="#">Jobaria.</a> All rights
                  reserved.</span>
              </div>
            </div>
            ...
            <div class="modal-inner-area sp-area row">
              ...
              <div class="col-lg-7 col-md-6 col-sm-6">
                <div class="sp-content">
                  ...
                  <div class="short-desc">
                    <p>
                      Janon's first 4K UHD Camcorder, the GX10 has a compact
                      and portable design that delivers outstanding video
                      quality with remarkable detail. With a combination of
                      incredible features and functionality, the GX10 is the
