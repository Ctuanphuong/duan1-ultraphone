                ...
                <div id="reviews" class="tab-pane" role="tabpanel">
                    <div class="product_comments_block">
                        ...
                        <div class="review-btn_area">
                            <a class="review-btn" href="#" data-bs-toggle="modal" data-bs-target="#mymodal">Đánh giá của bạn</a>
                        </div>
                        ...
                        <div class="jb-single_product">
                            ...
                            <div class="jb-product_content">
                                <div class="product-desc_info">
                                    <h6><a class="product-name" href="index.php?act=prodetail&idpro=<?php echo $pro['id_pro'] ?>"><?php echo $pro['name_pro']; ?></a></h6>
                                    <div class="rating-box">
                                        <ul>
                                            <li><i class="fa fa-star"></i></li>
                                            <li><i class="fa fa-star"></i></li>
