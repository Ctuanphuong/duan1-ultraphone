                        ...
                        <div class="jb-sidebar-catagories_area">
                            ...
                            <div class="jb-sidebar_banner">
                                <div class="banner-item">
                                    <a href="#">
                                        <img src="./src/image/shop/1.jpg" alt="JB's Shop Banner">
                                    </a>
                                </div>
                            </div>
                                            ...
                                            <div class="jb-single_product">
                                                ...
                                                <div class="jb-product_content">
                                                    <div class="product-desc_info">
                                                        ...
                                                        <div class="price-pro">
                                                            <span class="price-17">'.$price.' VNĐ</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                    ...
                    <div class="col-lg-9 order-1 order-lg-2">
                        <div class="shopbar-with_banner">
                            <div class="jb-sidebar_banner">
                                <div class="banner-item">
                                    <a href="#">
                                        <img src="./src/image/shop/2.jpg" alt="JB's Shop Banner">
                                    </a>
                                </div>
                            </div>
                                ...
                                <div class="shopbar-inner">
                                    <div class="product-view-mode">
                                        <ul class="nav shop-item-filter-list" role="tablist">
                                            <li class="active" role="presentation"><a aria-selected="true" class="active show" data-bs-toggle="tab" role="tab" aria-controls="grid-view" href="#grid-view"><i
                                                ...
                                                foreach($listpro as $pro) { 
                                                    ...
                                                    <div class="jb-single_product">
                                                        <div class="product-img">
                                                            ...
                                                            <div><a href="'.$linkpro.'" title="Quick View" class="quick-view-btn" data-bs-toggle="modal" data-bs-target="#exampleModalCenter"><i class="fa fa-search"></i></a></div>
                                                        </div>
                                                        <div class="jb-product_content">
                                                            <div class="product-desc_info">
                                                                <h6><a class="product-name" href="single-product.html">'.$name_pro.'</a></h6>
                                                                <div class="price-box">
                                                    ...
                                                    <div class="col-lg-8 col-md-8">
                                                        <div class="jb-product_content">
                                                            <div class="product-desc_info">
                                                                ...
                                                                <div class="price-box">
                                                                    <span class="old-price">50000000 VNĐ</span>
                                                                    <span class="new-price">'.$price.' VNĐ</span>
                                                                </div>
                                                            </div>
                                                            <div class="add-actions">
