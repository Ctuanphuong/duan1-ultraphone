                ...
                <div class="jb-product-tab_slider">
                    ...
                    <div class="jb-single_product">
                      <div class="product-img">
                        <a href="single-product.html">
                          <img src="./src/image/product/medium-size/1-1.jpg" alt="JB's Product Image" />
                        </a>
                      ...
                      <div class="jb-product_content">
                        <div class="product-desc_info">
                          ...
                          <h6>
                            <a class="product-name" href="single-product.html">Janon vista fhd 4k...</a>
                          </h6>
                  ...
                  <div class="jb-slide-item">
                    <div class="jb-single_product">
                      <div class="product-img">
                        <a href="single-product.html">
                          <img src="./src/image/product/medium-size/1-2.jpg" alt="JB's Product Image" />
                        </a>
                        <span class="sticker">New</span>
                        <div>
                          <a href="#" title="Quick View" class="quick-view-btn" data-bs-toggle="modal"
                      ...
                      <div class="jb-product_content">
                        <div class="product-desc_info">
                          ...
                          <h6>
                            <a class="product-name" href="single-product.html">Xail G120 32GB IOS 10...</a>
                          </h6>
                          <div class="rating-box">
                            <ul>
                              <li><i class="fa fa-star"></i></li>
                  ...
                  <div class="jb-slide-item">
                    <div class="jb-single_product">
                      <div class="product-img">
                        <a href="single-product.html">
                          <img src="./src/image/product/medium-size/1-3.jpg" alt="JB's Product Image" />
                        </a>
                        <span class="sticker">New</span>
                        <div>
                          <a href="#" title="Quick View" class="quick-view-btn" data-bs-toggle="modal"
                      ...
                      <div class="jb-product_content">
                        <div class="product-desc_info">
                          ...
                          <h6>
                            <a class="product-name" href="single-product.html">Full HD 8GB Flash Memory...</a>
                          </h6>
                          <div class="rating-box">
                            <ul>
                              <li><i class="fa fa-star"></i></li>
                  ...
                  <div class="jb-slide-item">
                    <div class="jb-single_product">
                      <div class="product-img">
                        <a href="single-product.html">
                          <img src="./src/image/product/medium-size/1-4.jpg" alt="JB's Product Image" />
                        </a>
                        <span class="sticker">New</span>
                        <span class="sticker-2">-10%</span>
                        <div>
                      ...
                      <div class="jb-product_content">
                        <div class="product-desc_info">
                          ...
                          <h6>
                            <a class="product-name" href="single-product.html">HD Video Recording PJ...</a>
                          </h6>
                          <div class="rating-box">
                            <ul>
                              <li><i class="fa fa-star"></i></li>
                  ...
                  <div class="jb-slide-item">
                    <div class="jb-single_product">
                      <div class="product-img">
                        <a href="single-product.html">
                          <img src="./src/image/product/medium-size/1-5.jpg" alt="JB's Product Image" />
                        </a>
                        <span class="sticker">New</span>
                        <div>
                          <a href="#" title="Quick View" class="quick-view-btn" data-bs-toggle="modal"
                      ...
                      <div class="jb-product_content">
                        <div class="product-desc_info">
                          ...
                          <h6>
                            <a class="product-name" href="single-product.html">720 Degree Panoramic HD 360...</a>
                          </h6>
                          <div class="rating-box">
                            <ul>
                              <li><i class="fa fa-star"></i></li>
                  ...
                  <div class="jb-slide-item">
                    <div class="jb-single_product">
                      <div class="product-img">
                        <a href="single-product.html">
                          <img src="./src/image/product/medium-size/1-6.jpg" alt="JB's Product Image" />
                        </a>
                        <span class="sticker">New</span>
                        <div>
                          <a href="#" title="Quick View" class="quick-view-btn" data-bs-toggle="modal"
                      ...
                      <div class="jb-product_content">
                        <div class="product-desc_info">
                          ...
                          <h6>
                            <a class="product-name" href="single-product.html">Xail 9.7" 128GB iPad -...</a>
                          </h6>
                          <div class="rating-box">
                            <ul>
                              <li><i class="fa fa-star"></i></li>
                  ...
                  <div class="jb-slide-item">
                    <div class="jb-single_product">
                      <div class="product-img">
                        <a href="single-product.html">
                          <img src="./src/image/product/medium-size/1-7.jpg" alt="JB's Product Image" />
                        </a>
                        <span class="sticker">New</span>
                        <div>
                          <a href="#" title="Quick View" class="quick-view-btn" data-bs-toggle="modal"
                  ...
                  <div class="jb-slide-item">
                    <div class="jb-single_product">
                      <div class="product-img">
                        <a href="single-product.html">
                          <img src="./src/image/product/medium-size/1-8.jpg" alt="JB's Product Image" />
                        </a>
                        <span class="sticker">New</span>
                        <div>
                          <a href="#" title="Quick View" class="quick-view-btn" data-bs-toggle="modal"
                      ...
                      <div class="jb-product_content">
                        <div class="product-desc_info">
                          ...
                          <h6>
                            <a class="product-name" href="single-product.html">Meito 12.2" Pentium, 4GB,...</a>
                          </h6>
                          <div class="rating-box">
                            <ul>
                              <li><i class="fa fa-star"></i></li>
                  ...
                  <div class="jb-slide-item">
                    <div class="jb-single_product">
                      <div class="product-img">
                        <a href="single-product.html">
                          <img src="./src/image/product/medium-size/1-9.jpg" alt="JB's Product Image" />
                        </a>
                        <span class="sticker">New</span>
                        <div>
                          <a href="#" title="Quick View" class="quick-view-btn" data-bs-toggle="modal"
                      ...
                      <div class="jb-product_content">
                        <div class="product-desc_info">
                          ...
                          <h6>
                            <a class="product-name" href="single-product.html">Xailbox 4 Pro 1TB Star...</a>
                          </h6>
                          <div class="rating-box">
                            <ul>
                              <li><i class="fa fa-star"></i></li>
                  ...
                  <div class="jb-slide-item">
                    <div class="jb-single_product">
                      <div class="product-img">
                        <a href="single-product.html">
                          <img src="./src/image/product/medium-size/1-10.jpg" alt="JB's Product Image" />
                        </a>
                        <span class="sticker">New</span>
                        <div>
                          <a href="#" title="Quick View" class="quick-view-btn" data-bs-toggle="modal"
                      ...
                      <div class="jb-product_content">
                        <div class="product-desc_info">
                          ...
                          <h6>
                            <a class="product-name" href="single-product.html">16 GB Grade A Unlocked...</a>
                          </h6>
                          <div class="rating-box">
                            <ul>
                              <li><i class="fa fa-star"></i></li>
                  ...
                  <div class="jb-slide-item">
                    <div class="jb-single_product">
                      <div class="product-img">
                        <a href="single-product.html">
                          <img src="./src/image/product/medium-size/1-11.jpg" alt="JB's Product Image" />
                        </a>
                        <span class="sticker">New</span>
                        <div>
                          <a href="#" title="Quick View" class="quick-view-btn" data-bs-toggle="modal"
                      ...
                      <div class="jb-product_content">
                        <div class="product-desc_info">
                          ...
                          <h6>
                            <a class="product-name" href="single-product.html">SanaFuel Wireless Over-Ear...</a>
                          </h6>
                          <div class="rating-box">
                            <ul>
                              <li><i class="fa fa-star"></i></li>
                  ...
                  <div class="jb-slide-item">
                    <div class="jb-single_product">
                      <div class="product-img">
                        <a href="single-product.html">
                          <img src="./src/image/product/medium-size/1-12.jpg" alt="JB's Product Image" />
                        </a>
                        <span class="sticker">New</span>
                        <div>
                          <a href="#" title="Quick View" class="quick-view-btn" data-bs-toggle="modal"
                      ...
                      <div class="jb-product_content">
                        <div class="product-desc_info">
                          ...
                          <h6>
                            <a class="product-name" href="single-product.html">Chamcham 15.6" AMD A9-9420,...</a>
                          </h6>
                          <div class="rating-box">
                            <ul>
                              <li><i class="fa fa-star"></i></li>
