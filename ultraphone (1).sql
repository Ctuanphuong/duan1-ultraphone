...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th12 13, 2022 lúc 03:36 PM
...
(68, '17983', 15, 0, 'phuongct', '', 'Chu Tuấn Phương', 'Ngọa Long, Minh Khai, Bắc Từ Liêm, Hà Nội', 335099885, 'ctuanphuong18@gmail.com', 1, '0000-00-00 00:00:00', 9180000, 3, '1'),
(69, '58463', 22, 0, 'mun', '', 'Mun Min', '', 924100761, 'minhnvph20397@fpt.edu.vn', 1, '2022-12-05 08:09:36', 6000000, 0, '0'),
(70, '21469', 22, 0, 'mun', '', '', '', 924100761, 'minhnvph20397@fpt.edu.vn', 1, '2022-12-05 08:13:15', 18600000, 0, '0'),
(71, '26983', 23, 0, 'min', '', 'Min mun', '', 0, 'minhnvph20397@fpt.edu.vn', 1, '2022-12-06 09:03:47', 18600000, 0, '0'),
(72, '85792', 23, 0, 'min', '', 'Minh Văn', 'Nam Từ Liên, Hà Nội', 924100761, 'minhnvph20397@fpt.edu.vn', 1, '2022-12-06 09:05:16', 20590000, 0, '0');
...
(58, 22, 'mun', 30, '9283447401-oppo-a77s-128gb-ram-8gb.jpg', 'OPPO A77S 8GB/128GB', 6000000, 1, 6000000, 69),
(59, 22, 'mun', 24, 'apple-iphone-x-new-1.jpg', 'iPhone X 512GB ', 18600000, 1, 18600000, 70),
(60, 23, 'min', 24, 'apple-iphone-x-new-1.jpg', 'iPhone X 512GB ', 18600000, 1, 18600000, 71),
(61, 23, 'min', 27, 'samsung-galaxy-z-flip4-5g-128gb-thumb-tim-600x600.jpg', 'Samsung Galaxy Z Flip 4', 20590000, 1, 20590000, 72);
...
(8, 'dsad', 23, 'min', 'Min mun', 27, '12/07/2022 11:29:05am'),
(9, 'dsad', 23, 'min', 'Min mun', 27, '12/07/2022 11:29:34am'),
(10, 'dsada', 23, 'min', 'Min mun', 24, '12/13/2022 04:45:24pm');
...
(4, 'Minh Văn', 'minhnvph20397@fpt.edu.vn', '0924100761', '• Màn hình: OLED6.7\"Super Retina XDR • Hệ điều hành: iOS 16 • Camera sau: Chính 48 MP & Phụ 12 MP, 12 MP • Camera trước: 12 MP • Chip: Apple A16 Bionic • RAM: 6 GB • Dung lượng lưu trữ: 256 GB • SIM: 1 Nano SIM & 1 eSIMHỗ trợ 5G • Pin, Sạc: 4323 mAh20 W'),
(12, 'Minh Vănxxxx', 'minhnvph20397@fpt.edu.vn', '0924100761', 'dsadasdasdsa'),
(13, 'Minh Vănxxxx', 'minhnvph20397@fpt.edu.vn', '0924100761', 'dsadsadsad sad asdasd á dsdas ');
...
(16, 'admin', '12345', 'Admin Ultraphone', 0, 'zatuzick03@gmail.com', '', '', '', NULL, NULL, 1),
...
--
ALTER TABLE `comment`
  MODIFY `id_cmt` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `question`
  MODIFY `id_ques` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
